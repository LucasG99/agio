...
The application is deployed to Render's free tier and publicly accessible at:

**https://agio-3.onrender.com**
...
| Dashboard | https://agio-3.onrender.com/painel.html |
| Employee page | https://agio-3.onrender.com/funcionario.html?empresa_id=1 |
| Health check | https://agio-3.onrender.com/api/health |

At login, any email and password are accepted (demo authentication). For the employee page, use a CPF from the seed data — e.g. `111.222.333-44` (Ana Silva, Padaria Flores, `empresa_id=1`).
